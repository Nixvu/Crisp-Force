            ...
            <div id="repairDetailModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden items-center justify-center" onclick="closeRepairDetailModal()">
                <div class="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto" onclick="event.stopPropagation()">
                    <div class="p-4 sm:p-6 border-b flex justify-between items-center">
                        <h3 class="text-lg font-semibold text-slate-800">Detail Perbaikan</h3>
                        <button onclick="closeRepairDetailModal()" class="text-slate-500 hover:text-red-600 p-2 rounded-full transition-colors">
                            <i data-lucide="x" class="w-5 h-5"></i>
                        </button>
                    </div>
                    <div id="repairDetailModalBody" class="p-4 sm:p-6">
                        <!-- Repair details will be loaded here by JavaScript -->
                    </div>
                </div>
            </div>
